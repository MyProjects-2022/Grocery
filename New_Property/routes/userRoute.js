...
// ,
router.post('/user/signup',	[isPasswordCheck,validationSignup,isUserExistsSignup],	usersController.signUp); // sends verification link to user
router.get('/user/signup/verify/:email_verify_token', usersController.signUpVerify); // verify user link when clicked
...
router.post('/user/update_profile',	[authenticateToken, validationUpdateProfile, isUserExistsUpdate],
...
// router.post('/user/checkmail',usersController.verify);
