...
const Rent = RentModel (sequelize);

const { PropertiesFeaturesModel } = require('./models/Properties_Features');
const PropertiesFeatures = PropertiesFeaturesModel (sequelize);
